package com.landgraf.workshopmongo.resources.exception;
...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<StandardError> objectNorFound(ObjectNotFoundException e, HttpServletRequest request){
        ...
        StandardError err = new StandardError(System.currentTimeMillis(), status, "Not Found", e.getMessage(), request.getRequestURI());
